...
import static com.cxhello.edu.utils.RSAEncoder.RSAEncrypt;

/**
 * @author CaiXiaoHui
 * @create 2020/1/10 22:14
 */
public class ZFsoft {
    ...
    private String encryp(String password){
        ...
        HttpGet gpkHttpGet=
                new HttpGet(Constant.PUBLICKEY_URL+new Date().getTime());
        ...
        gpkHttpGet.setHeader("Host",Constant.HOST);
        ...
        //二、根据公钥进行密码加密
        password= RSAEncrypt(password,B64.b64tohex(modulus),B64.b64tohex(exponent));
    ...
    private String crawlCsrfToken(String timestamp){
        ...
        HttpGet csrftokenHttpGet=
                new HttpGet(Constant.LOGIN_URL+timestamp);
    ...
    public ZFsoft login(String username,String password){
        ...
        HttpPost loginHttpPost=new HttpPost(Constant.LOGIN_URL+timestamp);
        ...
        loginHttpPost.setHeader("Host",Constant.HOST);
        loginHttpPost.setHeader("Origin",Constant.ORIGIN);
    ...
    public List<Score> checkScore(String xnm,String xqm){
        HttpPost scoreHttpPost=new HttpPost(Constant.CHECK_SCORE_URL);
        ...
        scoreHttpPost.setHeader("Host",Constant.HOST);
        scoreHttpPost.setHeader("Origin",Constant.ORIGIN);
